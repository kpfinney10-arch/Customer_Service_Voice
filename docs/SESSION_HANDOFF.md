...
1. Move the next live validation to another routine after-hours branch, preferably an existing-family service-time/visitation question or a family request to speak with the funeral director without a new death report, and capture any new transcript quirks as fixtures.
