...
1. Re-run the hospice/facility live validation on a fresh Twilio tunnel using the observed STT-shaped phrasing: `This is Nurse Sarah at Green Valley. Hospice, my phone here is 214. 639 5723`; `I'm calling about Mr. Robert Jones in room 214`; `We are at Green Valley. Hospice at 1297 Green, Mountain, Drive in South Lake, Texas`. Confirm the final facts preserve facility name, staff role, hospice place type, decedent name, callback, and pickup address.
