...
1. Move the next live validation to a different after-hours branch, preferably an unsupported/general question that should be politely captured for office follow-up, or a caller asking about obituary/flowers so the routine-family lane gets broader coverage.
