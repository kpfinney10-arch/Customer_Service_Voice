...
- The current pricing lane is a launch blocker: it asks for contact information and schedules follow-up instead of providing approved telephone price information. It must not handle real pricing inquiries until counsel and the funeral-home customer approve a compliant design.
...
## Confirmed engineering/legal gap: telephone pricing
...
Current LanternBell behavior does not meet that operating requirement for a real customer: the pricing path collects a name and callback number, creates a CRM lead, and promises office-hours follow-up without providing approved price-list information.
...
- [ ] A pricing caller can obtain required available price information without providing a name, address, or telephone number.
